    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonBox}>
          <Text style={{color:'red', fontSize:RFValue(18), fontWeight:'bold',marginLeft:55}}>EMAIL ID</Text>
          ...
          <Text style={{color:'red', fontSize:RFValue(18), fontWeight:'bold',marginLeft:55}}>PASSWORD</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
          ...
          <View style={{alignItems:'center'}}>
            <TouchableOpacity
              style={[styles.button,{marginBottom:RFValue(10)}]}
              onPress = {()=>{this.userLogin(this.state.emailId, this.state.password)}}
              >
              <Text style={{color:'white', fontSize:RFValue(18), fontWeight:'bold'}}>LOGIN</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
              onPress={()=>{
              ...
              >
                <Text style={{color:'white', fontSize:RFValue(18), fontWeight:'bold'}}>SIGN UP</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
